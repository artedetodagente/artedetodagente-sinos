...
function HomeFunarte() {
  return (
    <section id="funarte" className="home-curso full-section" style={{ backgroundImage: `url(${require('../assets/images/Funarte.jpg')})` }}>
      <div className="curso-info">
        <div className="col col-1">
          <div className="title">Funarte e UFRJ lançam Festival Arte de Toda Gente</div>
          <div className="content">
            ...
            <RedLink href="#">Inscreva-se</RedLink>
          </div>
        </div>
      </div>
    </section>
