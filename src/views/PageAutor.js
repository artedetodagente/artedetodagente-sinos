  ...
  return (
    <Page title="Repertório Sinos">
      <div className="breadcrumbs">
        ...
        {props.parent && (
          <span>
            <Link to={props.parent[1]}>{props.parent[0]}</Link> &raquo;&nbsp;
          </span>
        )}
      ...
      <div className="repertorio-container">
        <div className="left-container">
          <div className="image-container">
            <img
              src={`https://admin.sinos.art.br${image.url}`}
              alt={`${image.name}`}
            />
          </div>
          <div style={{ marginTop: "5vh" }}>
            {concertos.length && (
              <div className="autor-concertos">
                <p>
                  <strong>Concertos deste autor</strong>
                </p>
                <div>
            ...
            {obras.length && (
              <div className="autor-obras">
                <p>
                  <strong>Obras deste autor</strong>
                </p>
                <div>
                  {obras.map((obra, i) => (
